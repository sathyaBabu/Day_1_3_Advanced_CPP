...
//  17_Compose_Basic
//
//  Created by Sathya Babu on 21/06/23.
//

/*
 
  Works :
  The compose function now accepts variadic template parameters Funcs... fs,
 representing the multiple functions to be composed.
 The compose function uses recursion to compose the functions one by one.
 When there are no more functions to compose (sizeof...(fs) == 0),
